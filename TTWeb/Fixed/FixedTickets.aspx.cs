...
namespace TTWeb
{
    public partial class FixedTickets : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsCallback)
            {
                ...
                {
                    //if (Global.CustomSession["FixedTicketsTable"] == null)
                    {
                        MasterDataBind();
                    }
                    //else
                    //{
                    //    ASPxGridViewFixedTickets.DataSource = Global.CustomSession["FixedTicketsTable"];
                    //}
                }
                else
                {
            ...
            ASPxGridViewFixedTickets.SettingsText.ConfirmDelete = "Are you sure that you want to delete the specific Ticket?";
        }

        private void MasterDataBind()
        {
            ASPxGridViewFixedTickets.DataSource = Global.ExecuteStoredProcedure("W_Sites_List", new string[0] { }, new Object[0] { });
            Global.CustomSession["FixedTicketsTable"] = ASPxGridViewFixedTickets.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("FixedTicketsTable");
            ASPxGridViewFixedTickets.DataBind();
        }
        ...
        {
            //ASPxGridViewFixedTickets.Columns["Attention"].Visible = !show;
            //ASPxGridViewFixedTickets.Columns["Priority"].Visible = !show;
            //ASPxGridViewFixedTickets.Columns["Kintec_Rejection_Status_Flag"].Visible = !show;
            //ASPxGridViewFixedTickets.Columns["Freeze_Flag"].Visible = !show;
            //ASPxGridViewFixedTickets.Columns["Restore_Freeze"].Visible = !show;
            //ASPxGridViewFixedTickets.Columns["Response_Freeze"].Visible = !show;
        }
        ...
        protected void ASPxGridViewFixedTickets_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
        ...
        protected void ASPxGridViewFixedTickets_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
        ...
        protected void ASPxGridViewFixedTickets_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
        ...
        protected void ASPxGridViewFixedTickets_Load(object sender, EventArgs e)
        {
        ...
        protected void ASPxGridViewLocation_BeforePerformDataSelect(object sender, EventArgs e)
        {
            ...
            string mLocation = ASPxGridViewFixedTickets.GetRowValuesByKeyValue(keyValue, "SITE").ToString();
        ...
        protected void ASPxGridViewFixedTickets_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
        ...
        protected void ASPxImage1_CustomJSProperties(object sender, DevExpress.Web.CustomJSPropertiesEventArgs e)
        {
            ...
            if (Latitude != "" && Longitude != "")
            {
                ...
                //e.Row.Cells[3].Controls ASPxGridViewFixedTickets
                //Control mControl = ASPxGridViewFixedTickets.FindRowCellTemplateControl(e.VisibleIndex, null, "Map");
            }
            e.Properties["cpCoords"] = coordinate;
        }

        protected void ASPxGridViewFixedTickets_HtmlRowPrepared(object sender, ASPxGridViewTableRowEventArgs e)
        {
        ...
        protected void ASPxGridViewFixedTickets_HtmlRowCreated(object sender, ASPxGridViewTableRowEventArgs e)
        {
            if (e.RowType == GridViewRowType.Data)
            {
                ASPxImage mButton = ASPxGridViewFixedTickets.FindRowCellTemplateControl(e.VisibleIndex, ASPxGridViewFixedTickets.Columns[13] as GridViewDataColumn, "mapbutton") as ASPxImage;
                mButton.CustomJSProperties += new DevExpress.Web.CustomJSPropertiesEventHandler(FixedTickets_CustomJSProperties);
            }
        }
        ...
        void FixedTickets_CustomJSProperties(object sender, DevExpress.Web.CustomJSPropertiesEventArgs e)
        {
            object keyval = ((sender as ASPxImage).NamingContainer as GridViewDataItemTemplateContainer).KeyValue;
            object[] res = (object[])ASPxGridViewFixedTickets.GetRowValuesByKeyValue(keyval, new string[3] { "LATITUDE", "LONGITUDE", "SiteName" });

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TTWeb.Default" %>
                    ...
                    <table align="center" width="250">
                        <tr>
                            <td align="center" height="50px" style="font-size: small" width="100">
                                User Name</td>
                            <td width="100">
                                <dx:ASPxTextBox ID="Username" runat="server" ClientIDMode="AutoID" 
                                    CssFilePath="~/App_Themes/BlackGlass/{0}/styles.css" CssPostfix="BlackGlass" 
                                    SpriteCssFilePath="~/App_Themes/BlackGlass/{0}/sprite.css" Width="150px" 
                                    Font-Size="Small" Height="26px" CssClass="style1">
                        ...
                        <tr>
                            <td align="center" height="50px" style="font-size: small" width="100">
                                Password</td>
                            <td width="100">
                                <dx:ASPxTextBox ID="Password" runat="server" ClientIDMode="AutoID" 
                                    CssFilePath="~/App_Themes/BlackGlass/{0}/styles.css" CssPostfix="BlackGlass" 
                                    Password="True" SpriteCssFilePath="~/App_Themes/BlackGlass/{0}/sprite.css" 
                                    Width="150px" Font-Size="Small" Height="26px">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="Text">
                                        <ErrorFrameStyle ImageSpacing="4px">
                                            <ErrorTextPaddings PaddingLeft="4px" />
                                        </ErrorFrameStyle>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <dx:ASPxButton ID="ASPxButtonLogIn" runat="server" ClientIDMode="AutoID" 
                                    ...
                                    SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" Text="Log in" 

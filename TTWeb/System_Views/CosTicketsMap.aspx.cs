...
{
    public partial class CosTicketsMap : System.Web.UI.Page
    {
        ...
        protected void ASPxCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            DataTable mTable = Global.ExecuteStoredProcedure("ActiveCos_Tickets_Map", new string[2] { "@Priority", "@Phase" }, new Object[2] { mres[0], mres[1] });
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;
  ...
  //          ASPxComboBoxPeriod.Items.Add("All", "All");
            ...
            {
                ASPxComboBoxPeriod.Items.Add(mDataTable.Rows[i]["SEVERITY"].ToString(), mDataTable.Rows[i]["SEVERITY"]);
            }
        }
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewMissing.DataSource = Global.ExecuteStoredProcedure("ActiveCos_Tickets_NOT_Map", new string[2] { "@Priority", "@Phase" }, new Object[2] { ASPxComboBoxPeriod.Text, ASPxComboBoxPhase.Text });

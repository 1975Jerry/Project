    ...
    public partial class UploadTickets : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsCallback)
            {
                ...
                {
                    if (Global.CustomSession["UploadTicketsTableErrors"] != null)
                    {
                        ASPxGridViewUploadTicketsErrors.DataSource = Global.CustomSession["UploadTicketsTableErrors"];
                        ASPxGridViewUploadTicketsErrors.DataBind();
                    }
                    else
                    {
                        MasterDataBind();
        ...
        private void MasterDataBind()
        {
            ...
            {
                ASPxGridViewUploadTicketsErrors.DataSource = Global.CustomSession["UploadTicketsTableErrors"];
                ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("UploadTicketsTableErrors");
                ASPxGridViewUploadTicketsErrors.DataBind();
            }
        }
        ...
        {
            DataTable mTable = (DataTable)Global.CustomSession["UploadTicketsTable"];
            ...
            Global.CustomSession["UploadTicketsTable"] = mTable;
            ((ASPxGridView)sender).CancelEdit();
            e.Cancel = true;
            /*ASPxGridViewUploadTickets.DataSource = mTable;
            ASPxGridViewUploadTickets.DataBind();*/

            SqlConnection mSqlConnection = new SqlConnection(Global.GetConnectionString());
            SqlDataAdapter mAdapter = new SqlDataAdapter("select * from TICKET_STAGE", mSqlConnection);
            ...
            if (affectedRows != 0)
            {
                DataTable ErrorsTable = (DataTable)Global.CustomSession["UploadTicketsTableErrors"];

                ErrorsTable.Rows.Remove(ErrorsTable.Rows.Find(e.Keys[0]));
                ASPxGridViewUploadTicketsErrors.DataSource = ErrorsTable;
                ASPxGridViewUploadTicketsErrors.DataBind();
            }
            Global.ExecuteStoredProcedure("UploadTickets_Synchronize", new string[0] { }, new Object[0] { });
        }
        ...
        {
            Global.CustomSession.Remove("UploadTicketsTable");
            Global.CustomSession.Remove("UploadTicketsTableErrors");
            ...
            if (mErrorTable != null)
            {
                ...
                Global.CustomSession["UploadTicketsTableErrors"] = mErrorTable;
            }
            try
            {
                ...
                mSqlConnection.Close();
                mSqlConnection.Dispose();
                Global.CustomSession["UploadTicketsTable"] = mDataTable;
            }
            catch (Exception e)
            {
                mSqlConnection.Close();
        ...
        {
            if (Global.CustomSession["UploadTicketsTable"] != null)
            {
                e.Properties["cpgoodrows"] = ((DataTable)Global.CustomSession["UploadTicketsTable"]).Rows.Count;
            }
            if (Global.CustomSession["UploadTicketsTableErrors"] != null)
            {
                e.Properties["cperrorrows"] = ((DataTable)Global.CustomSession["UploadTicketsTableErrors"]).Rows.Count;
            }
        }

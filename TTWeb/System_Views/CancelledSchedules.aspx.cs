...
namespace TTWeb
{
    public partial class CancelledSchedules : System.Web.UI.Page
    {
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewAllSCHs.DataSource = Global.ExecuteStoredProcedure("View_All_Cancelled_SCHs", new string[1] { "@USER_ID" }, new Object[1] { Global.CustomSession["UserId"] });
            Global.CustomSession["AllCancelledSchedulesTable"] = ASPxGridViewAllSCHs.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("AllCancelledSchedulesTable");

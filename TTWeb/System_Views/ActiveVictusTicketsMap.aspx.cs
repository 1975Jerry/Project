...
{
    public partial class ActiveVictusTicketsMap : System.Web.UI.Page
    {
        ...
        protected void ASPxCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            DataTable mTable = Global.ExecuteStoredProcedure("Victus_ActiveTickets_Map", new string[4] { "@Freezed", "@Priority", "@Period", "@Processed" }, new Object[4] { mres[0], mres[1], mres[2], mres[3] });
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewMissing.DataSource = Global.ExecuteStoredProcedure("Victus_ActiveTickets_NOT_Map", new string[4] { "@Freezed", "@Priority", "@Period", "@Processed" }, new Object[4] { ASPxComboBoxFreezed.Text, ASPxComboBoxPriority.Text, ASPxComboBoxPeriod.Text, ASPxComboBoxProcessed.Text });

...
{
    public partial class ActiveMoreTicketsMap : System.Web.UI.Page
    {
        ...
        protected void ASPxCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            DataTable mTable = Global.ExecuteStoredProcedure("ActiveMORE_Tickets_Map", new string[2] { "@Priority", "@Phase" }, new Object[2] { mres[0], mres[1] });
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;
  ...
  //          ASPxComboBoxPeriod.Items.Add("All", "All");
            ...
            {
                ASPxComboBoxPeriod.Items.Add(mDataTable.Rows[i]["Type"].ToString(), mDataTable.Rows[i]["Type"]);
            }
        }
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewMissing.DataSource = Global.ExecuteStoredProcedure("ActiveMORE_Tickets_NOT_Map", new string[2] { "@Priority", "@Phase" }, new Object[2] { ASPxComboBoxPeriod.Text, ASPxComboBoxPhase.Text });

...
namespace TTWeb
{
    public partial class SignOffSchedules : System.Web.UI.Page
    {
        ...
        {
            Global.UpdateTitle(ASPxRoundPanel1);
            ASPxGridViewAllSCHs.DataSource = Global.ExecuteStoredProcedure("View_All_SignOff_SCHs", new string[1] { "@USER_ID" }, new Object[1] { Global.CustomSession["UserId"] });
            Global.CustomSession["AllSignOffSchedulesTable"] = ASPxGridViewAllSCHs.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("AllSignOffSchedulesTable");

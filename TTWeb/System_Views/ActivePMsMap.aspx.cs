...
{
    public partial class ActivePMsMap : System.Web.UI.Page
    {
        ...
        protected void ASPxCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            DataTable mTable = Global.ExecuteStoredProcedure("ActivePMs_Map", new string[2] { "@Priority", "@Period" }, new Object[2] { mres[0], mres[1] });
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewMissing.DataSource = Global.ExecuteStoredProcedure("ActivePMs_NOT_Map", new string[2] { "@Priority", "@Period" }, new Object[2] { ASPxComboBoxPriority.Text, ASPxComboBoxPeriod.Text });
        ...
        protected void ASPxComboBoxPriority_Load(object sender, EventArgs e)
        {
            ...
            {
                ASPxComboBoxPriority.Items.Add(mDataTablePriority.Rows[i]["CRITICALITY"].ToString(), mDataTablePriority.Rows[i]["CRITICALITY"]);
            }
        }
        ...
        protected void ASPxComboBoxPeriod_Load(object sender, EventArgs e)
        {
            ...
            {
                ASPxComboBoxPeriod.Items.Add(mDataTablePeriod.Rows[i]["PM_YEAR"].ToString(), mDataTablePeriod.Rows[i]["PM_YEAR"]);
            }

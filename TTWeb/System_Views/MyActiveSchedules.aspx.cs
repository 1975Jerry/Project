...
namespace TTWeb
{
    public partial class MyActiveSchedules : System.Web.UI.Page
    {
        ...
        {
            ASPxGridViewAllSCHs.DataSource = Global.ExecuteStoredProcedure("View_My_Active_SCHs", new string[1] { "@USER_ID" }, new Object[1] { Global.CustomSession["UserId"] });
            Global.CustomSession["AllMyActiveSchedulesTable"] = ASPxGridViewAllSCHs.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("AllMyActiveSchedulesTable");

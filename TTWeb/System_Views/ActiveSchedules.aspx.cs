...
namespace TTWeb
{
    public partial class ActiveSchedules : System.Web.UI.Page
    {
        ...
        {
            Global.UpdateTitle(ASPxRoundPanel1);
            ASPxGridViewAllSCHs.DataSource = Global.ExecuteStoredProcedure("View_All_Active_SCHs", new string[1] { "@USER_ID" }, new Object[1] { Global.CustomSession["UserId"] });
            Global.CustomSession["AllActiveSchedulesTable"] = ASPxGridViewAllSCHs.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("AllActiveSchedulesTable");

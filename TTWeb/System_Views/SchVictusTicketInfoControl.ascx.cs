...
namespace TTWeb
{
    ...
    public class VictusTicketInfo
    {
        ...
        public VictusTicketInfo()
        {
            
        }

        public VictusTicketInfo(DataRow aRow)
        {
    ...
    public partial class SchVictusTicketInfoControl : UserControl
    {
        public SchVictusTicketInfoControl()
        {
            this.EnableViewState = true;
        }

        public VictusTicketInfo TTData
        {
            get
            {
                if (Global.CustomSession["VictusTicketInfo"] != null)
                {
                    return (VictusTicketInfo)Global.CustomSession["VictusTicketInfo"];
                }
                return null;
            }
            set
            {
                Global.CustomSession["VictusTicketInfo"] = value;
                ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("VictusTicketInfo");
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsCallback)
            {
                ...
                if (TTData == null)
                {
                    ...
                    DataTable mdataTable = Global.ExecuteStoredProcedure("Victus_ActiveTickets_Info", new string[2] { "@tt_id", "@user_id" }, new Object[2] { Global.CustomSession["Ticket_ID"], Global.CustomSession["UserId"] });
                    mRow = mdataTable.Rows[0];
                    TTData = new VictusTicketInfo(mdataTable.Rows[0]);
                    //BindRightsButtons();
                    BindGeneralInformation();
                }
        ...
        private void BindGeneralInformation()
        {
            ...
            if (TTData != null)
            {
                ...
                VictusTicketType.Value = TTData.Ticket_Type;

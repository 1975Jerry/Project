...
namespace TTWeb
{
    public partial class VisitsPendingLastMonth : System.Web.UI.Page
    {
        ...
        {
            //Global.UpdateTitle(ASPxRoundPanel1);
            ASPxGridViewAllVisits.DataSource = Global.ExecuteStoredProcedure("View_SCH_Visits_Pending_Last_Month", new string[1] { "@USER_ID" }, new Object[1] { Global.CustomSession["UserId"] });
            Global.CustomSession["AllVisitsPendingLastMonthTable"] = ASPxGridViewAllVisits.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("AllVisitsPendingLastMonthTable");

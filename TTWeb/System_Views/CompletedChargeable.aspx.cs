...
namespace TTWeb
{
    public partial class CompletedChargeable : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsCallback)
            {
                ...
                {
                    if (Global.CustomSession["CompletedChargeableTable"] == null)
                    {
                        MasterDataBind();
                    }
                    else
                    {
                        ASPxGridViewCompletedChargeable.DataSource = Global.CustomSession["CompletedChargeableTable"];
                    }
                }
                else
                {
            ...
            ASPxGridViewCompletedChargeable.SettingsText.ConfirmDelete = "Are you sure that you want to delete the specific Chargeable Ticket definition?";
        }

        private void MasterDataBind()
        {
            ASPxGridViewCompletedChargeable.DataSource = Global.ExecuteStoredProcedure("CH_Completed_List", new string[0] { }, new Object[0] { });
            Global.CustomSession["CompletedChargeableTable"] = ASPxGridViewCompletedChargeable.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("CompletedChargeableTable");
            ASPxGridViewCompletedChargeable.DataBind();
        }

        protected void ASPxButton1_Click(object sender, EventArgs e)
        {
            ASPxGridViewCompletedChargeable.AddNewRow();
        }
        ...
        protected void ASPxCallbackSRI_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            ASPxGridView mGrid = ASPxGridViewCompletedChargeable;
        ...
        {
            //ASPxGridViewCompletedChargeable.Columns["Attention"].Visible = !show;
            //ASPxGridViewCompletedChargeable.Columns["Priority"].Visible = !show;
            //ASPxGridViewCompletedChargeable.Columns["Kintec_Rejection_Status_Flag"].Visible = !show;
            //ASPxGridViewCompletedChargeable.Columns["Freeze_Flag"].Visible = !show;
            //ASPxGridViewCompletedChargeable.Columns["Restore_Freeze"].Visible = !show;
            //ASPxGridViewCompletedChargeable.Columns["Response_Freeze"].Visible = !show;
        }
        ...
        protected void ASPxGridViewCompletedChargeable_HtmlRowPrepared(object sender, ASPxGridViewTableRowEventArgs e)
        {
        ...
        protected void ASPxGridViewCompletedChargeable_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            Global.ExecuteStoredProcedureNoResults("CH_Insert_Update", new string[17] { "@CH_ID", "@SRI", "@PROJECT", "@SITE", "@SITE_TYPE", "@REGION", "@DESCRIPTION", "@AED", "@REQUEST_DATE", "@OFFER_DATE", "@APPROVAL_DATE", "@COMPLETION_DATE", "@INVOICE_DATE", "@NOTES", "@STATUS", "@USER_ID", "@ToBeScheduled" },
               ...
               new Object[17] 
                { System.DBNull.Value, e.NewValues["SRI"], e.NewValues["PROJECT"], e.NewValues["SITE"], e.NewValues["SITE_TYPE"], e.NewValues["REGION"], e.NewValues["DESCRIPTION"],
                    ...
                    e.NewValues["NOTES"], e.NewValues["STATUS"], e.NewValues["USER_ID"], e.NewValues["ToBeScheduled"]});
        ...
        protected void ASPxGridViewCompletedChargeable_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            Global.ExecuteStoredProcedureNoResults("CH_Insert_Update", new string[17] 
                { "@CH_ID", "@SRI", "@PROJECT", "@SITE", "@SITE_TYPE", "@REGION", "@DESCRIPTION", "@AED","@REQUEST_DATE", "@OFFER_DATE", "@APPROVAL_DATE", "@COMPLETION_DATE","@INVOICE_DATE", "@NOTES", "@STATUS", "@USER_ID", "@ToBeScheduled"},
        ...
        protected void ASPxGridViewCompletedChargeable_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
        ...
        //protected void ASPxGridViewCompletedChargeable_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        //{
        ...
        //protected void ASPxGridViewCompletedChargeable_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        //{
        ...
        protected void ASPxGridViewCompletedChargeable_Load(object sender, EventArgs e)
        {
        ...
        protected void ASPxGridViewCompletedChargeable_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            (sender as ASPxGridView).DetailRows.CollapseAllRows();
        }

        protected void ASPxGridViewCompletedChargeable_HtmlRowCreated(object sender, ASPxGridViewTableRowEventArgs e)
        {

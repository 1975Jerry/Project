...
{
    public partial class ActiveWindTicketsMap : System.Web.UI.Page
    {
        ...
        {
            string a = ASPxComboBoxProcessed.Text;
            //DataTable mTable = Global.GetSystemCoordinates();
            string[] mres = e.Parameter.Split(new char[1]{';'});
            DataTable mTable = Global.ExecuteStoredProcedure("W_ActiveTickets_Map", new string[3] { "@Priority", "@Period", "@Processed" }, new Object[3] { mres[0], mres[1], mres[2] });
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewMissing.DataSource = Global.ExecuteStoredProcedure("WActiveTickets_NOT_Map", new string[3] { "@Priority", "@Period", "@Processed" }, new Object[3] { ASPxComboBoxPriority.Text, ASPxComboBoxPeriod.Text, ASPxComboBoxProcessed.Text});

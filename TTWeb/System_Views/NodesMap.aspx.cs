...
{
    public partial class ActiveNodesMap : System.Web.UI.Page
    {
        ...
        protected void ASPxCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            DataTable mTable = Global.ExecuteStoredProcedure("ActiveNodes_Map", new string[1] {"@Period" }, new Object[1] { mres[0]});
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;

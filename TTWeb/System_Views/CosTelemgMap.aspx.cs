...
{
    public partial class CosTelemgMap : System.Web.UI.Page
    {
        ...
        protected void ASPxCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            DataTable mTable = Global.ExecuteStoredProcedure("ActiveCosTelemg_Map", new string[1] { "@Priority" }, new Object[1] { mres[0] });
            DataRow mRow = null;
            string mCoordinate;
            decimal Hours;
            decimal Minutes;
  ...
  //          ASPxComboBoxPeriod.Items.Add("All", "All");
        ...
        private void MasterDataBind()
        {
            ...
            ASPxGridViewMissing.DataSource = Global.ExecuteStoredProcedure("ActiveCosTelemg_NOT_Map", new string[1] { "@Priority"}, new Object[1] { ASPxComboBoxPeriod.Text});

...
namespace TTWeb
{
    public partial class VisitsNotPerformedLastMonth : System.Web.UI.Page
    {
        ...
        {
            //Global.UpdateTitle(ASPxRoundPanel1);
            ASPxGridViewAllVisits.DataSource = Global.ExecuteStoredProcedure("View_SCH_Visits_Not_Performed_Last_Month", new string[1] { "@USER_ID" }, new Object[1] { Global.CustomSession["UserId"] });
            Global.CustomSession["AllVisitsNotPerformedLastMonthTable"] = ASPxGridViewAllVisits.DataSource;
            ((SessionResourceTracker)Global.CustomSession["SessionResourceTracker"]).AddForCleanup("AllVisitsNotPerformedLastMonthTable");

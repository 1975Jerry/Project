...
function CalculateCredit() {
    return Math.round((spingas_credit.GetValue() + consumablecost_credit.GetValue() + spinovernight_credit.GetValue() + spintaxi_credit.GetValue() + spinparking_credit.GetValue() + spinothercarexpenses_credit.GetValue() + spinferrytickets_credit.GetValue() + spinferrycarlimitviolation_credit.GetValue() + spinairlinetickets_credit.GetValue() + spinairlineoverweight_credit.GetValue() + spinothertickets_credit.GetValue() + spinofficeexpenses_credit.GetValue()) * 100) / 100;
}

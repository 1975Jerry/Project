...
if (ToTeam.GetIsValid() &amp;&amp; ToTeam.GetSelectedItem().text == &quot;Dispatcher&quot;)   /* customia */
{
 ...
 kilometersread.SetText(gridViewProblems.cpTotalKM + s.GetNumber());
    ...
    costadvance.SetText(String(Math.round((cost-spinadvance.GetValue())*100)/100));
                                                                                            ...
                                                                                            <td class="style84">
                                                                                                <dx1:ASPxSpinEdit ID="ASPxSpinToll_credit" runat="server" ClientInstanceName="spintoll_credit" CssClass="Inline" DecimalPlaces="2" DisplayFormatString="N" EnableClientSideAPI="True" Font-Size="8pt" Height="21px" MaxValue="5000" Number="0" style="font-size: 8pt" Theme="Aqua" Width="150px">
                                                                                                    <ClientSideEvents NumberChanged="function(s, e) {
    var credit = CalculateCredit();
    totalcost0.SetText(String(credit));
    totalcostcredit.SetText(String(credit));
                                                                                                ...
                                                                                                <dx1:ASPxLabel ID="ASPxLabelToll_credit" runat="server" CssClass="Inline" Font-Size="8pt" style="color: #C0C0C0">
                                                                                                </dx1:ASPxLabel>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>

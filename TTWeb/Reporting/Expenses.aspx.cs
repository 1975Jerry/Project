...
namespace TTWeb
{
    public partial class Expenses : System.Web.UI.Page
    {
        ...
        protected TTWeb.Reporting.Expenses_Xrep GetReport()
        {

            TTWeb.Reporting.Expenses_Xrep report = new TTWeb.Reporting.Expenses_Xrep();
        ...
        {
            FromDay.Date = DateTime.Now.AddDays(-7);
        }
        ...
        protected void ASPxComboBoxUsers_Init(object sender, EventArgs e)
        {
            ...
            DataTable mDataTablePeriod = Global.ExecuteStoredProcedure("All_Engineers_Lookup", null, null);
            ...
            ASPxComboBoxUsers.SelectedIndex = 0;
        }
